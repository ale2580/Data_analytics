...
insert into prof values (1, 'Perlin','Ken','PeRK','1');
insert into prof values (2,'Turing', 'Alan','alanT','1234');
insert into prof values (3,'Conway', 'John','Jcon','1234');
insert into prof values (4,'Naur', 'Peter','Pnaur','1234');
...
insert into offering values ('Comp3311',224,'Spring2021',322,110,2);
insert into offering values ('Comp3311',230,'Spring2021',322,105,1);
...
insert into TA values (101,'Clay','Zoe',12345678,'Comp3311',223);
insert into TA values (102,'Attwater','Lucian Kiley',23456781,'Comp3311',224);
insert into TA values (103,'Yong','Erica',34567812,'Comp3311',230);
insert into TA values (104,'Gilliam','Nickolas Joseph',45678123,'Comp3311',222);
insert into TA values (105,'Pearson','Nikolas Myron',56781234,'Comp4311',100);
